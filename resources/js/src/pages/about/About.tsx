...
export default function TopFive() {
    return (
        <main className="container mx-auto p-4">
            <title>About Suggest a Flick</title>
            <meta
                name="description"
                content="Learn why Suggest a Flick is the #1 AI-powered movie recommendation engine. Personalized picks across Netflix, Prime, Hulu, Disney+, and more."
            />
            <meta
                name="keywords"
                content="AI movie recommendations, personalized film picks, Netflix, Hulu, Prime, Disney+, movie engine"
            />
            <h1 className="text-4xl font-bold text-center mb-6">About Suggest a Flick</h1>

            <p className="text-xl my-4">
                Fed up with endless scrolling on Netflix? Movie Oracle is your AI-powered movie recommendation engine
                that delivers personalized film picks.
            </p>

            <h2 className="text-3xl font-semibold mt-8 mb-4">Why Suggest a Flick</h2>
            <ul className="list-disc list-inside text-xl space-y-2">
                ...
                <li><strong>Laser-precise:</strong> Discovers hidden gems, sometimes even films without a proper English
                    translations (as long as they're latin script).
                </li>
            </ul>

            <h2 className="text-3xl font-semibold mt-8 mb-4">How It Works</h2>
            <p className="text-xl my-4">
                Suggest a Flick combines Google Search grounding with the Gemini LLM API. Every suggestion is validated
                against a comprehensive movie database to keep hallucinations near zero. If a title can’t be verified,
                you’ll see an error instead of nonsense.
            </p>
