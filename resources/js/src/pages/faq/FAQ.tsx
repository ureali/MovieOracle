            ...
            <div className="space-y-4">
                <details className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="mt-2 text-lg">
                        Just type a description (genre, year, mood, even a fragment of the plot!) into the search box and
                ...
                <details className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="mt-2 text-lg">
                        ...
                        Oracle’s smart matching will find it for you. For instance, "I forgot, but there was a movie, something about milkshake and pumpkin" matched to Pulp Fiction as the first result. Oracle tries to find up to 5 movies, which increases the chances of match.
                    </p>
                </details>
                ...
                <details className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="mt-2 text-lg">
                        Yes! Movie Oracle covers international cinema and even titles without English translations. However, for
                ...
                <details className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="mt-2 text-lg">
                        Almost 100% spot-on. During my testing, at maximum it missed 1-2 aspects of the description if it was hyper-specific.
                    </p>
                </details>
            </div>
        </main>
