    ...
    return (
        <>
            ...
            <main className="text-center">
                ...
                <section className="flex flex-row max-lg:flex-col justify-between items-stretch w-2/3 max-2xl:w-3/4 max-xl:w-11/12 mx-auto mt-16">
                    <div className="flex flex-col justify-evenly">
                        ...
                        <div className="flex flex-row justify-between mt-2">
                            ...
                            <HowToUseCard step="3" title="Watch" description="Get a recommendation and enjoy!" icon="🍿"/>
                        </div>

                        </div>
                        <div>
                            <img src={oracle} alt="An orangutan in beret holding popcorn and movie tape" className="max-h-full max-lg:w-1/2 max-lg:my-4 mx-auto object-contain"/>
                        </div>
